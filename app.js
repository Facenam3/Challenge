...
function renderData(){
    ...
    data.slice(startIndex, takeIndex).forEach(item => {
        console.log(item);
        let jsonDataCard = ` 
                        <div>
                    <article id="card-item">
                        <div class="profile-info">
                            <img src=${item.profile_image} class="prof-img" alt=${item.name}>
                            <div class="info">
                            <h3 class="prof-name">${item.name}</h3>
                            <p class="date"> ${item.date}</p>
                            </div>
                            <img src="./images/instagram-logo.svg" class="instagram-logo" alt="instagram-logo">
                        </div>
                        <div class="profile-image">
                            <img src=${item.image} class="card-img" alt="profile-image">
        ...
        container.innerHTML += jsonDataCard;
        counter++;
    })
}
